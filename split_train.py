...
def get_args():
    ...
    parser.add_argument('-e', '--epochs', metavar='E', type=int, default=14,
    ...
    parser.add_argument('-bg','--budget',metavar='BG',type=int,nargs='?',default=56,
    ...
    parser.add_argument('-mp', '--mnet-path', type=str, default='/home/huangz78/checkpoints/mnet_split_trained.pth',
                        help='path file for a mnet', dest='mnetpath')
    parser.add_argument('-up', '--unet-path', type=str, default='/home/huangz78/checkpoints/unet_split_trained.pth',
                        help='path file for a unet', dest='unetpath')
    parser.add_argument('-mbit', '--mb-iter-max', type=int, default=15,
...
if __name__=='__main__':
    ...
    alternating_update_with_unetRecon(mnet,UNET,train_full,yfulls=yfull,\
                                  maxIter_mb=args.maxItermb,alpha=10**(-5.5),c=5e-2,lr_mb=args.lrb,\
